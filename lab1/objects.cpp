...
MovableObject::MovableObject()             // konstruktor                   
{
	...
	steer_wheel_ret_speed = 4.0; // prêdkoœæ powrotu kierownicy w rad/s
...
{                                                // dzia³aj¹cych si³ i czasu, jaki up³yn¹³ od ostatniej symulacji
	...
	float friction = 5.0;            // wspó³czynnik tarcia obiektu o pod³o¿e
	float friction_rot = friction;
	float friction_roll = 0.05;    // wspó³czynnik tarcia tocznego
	...
	// wyznaczam prêdkoœæ podbicia (wznoszenia œrodka pojazdu spowodowanej wklês³oœci¹) 
	// oraz prêdkoœæ k¹tow¹
