...
extern long group_time_after_start;
...
void StandardViewParametersSetting(ViewParameters *p)
{
	...
	p->distance = 21.0;                          // distance lub przybli¿enie kamery
...
void DrawScene()
{
	float czas = (float)(group_time_after_start + clock() - start_time) / CLOCKS_PER_SEC;  // czas od uruchomienia w [s]
