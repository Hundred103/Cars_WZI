...
void InteractionInitialisation()
{
	...
	multi_reciv = new multicast_net("224.10.12.110", 10001);      // Object do odbioru ramek sieciowych
	multi_send = new multicast_net("224.10.12.110", 10001);       // Object do wysy³ania ramek
	...
	int       nCmdShow)
{
	...
	main_window = CreateWindow(class_name, "WZR 2025/26, temat 6, wersja g [Y-autopilot, F11-autop.test]", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_CLIPCHILDREN | WS_CLIPSIBLINGS,
